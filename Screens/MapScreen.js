import { StyleSheet, Modal, View, Text, TouchableOpacity, Button } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            ...
            <Modal visible={showModal} animationType='slide' style={{flex: 1}}>
                <View style={{flexDirection: 'row', paddingTop: 50, paddingRight: 30, justifyContent: 'flex-end'}}>
                    <TouchableOpacity style={{backgroundColor: "yellow", borderRadius: 20,
                                              elevation: 10, shadowColor: 'black', shadowOffset: {width: 2, height: 5},
                                              shadowOpacity: 0.25, shadowRadius: 4, borderColor: 'black', borderWidth: 0.3}} 
